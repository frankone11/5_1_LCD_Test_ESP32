...
void app_main(void)
{
	...
	///* LANDSCAPE
	// 显示字符串
	LCD_ShowString(225,160,GREEN,RED,12,"ABCDabcd123",1);
	LCD_ShowString(225,172,GREEN,RED,12,"ABCDabcd123",0);
	LCD_ShowString(225,184,GREEN,RED,16,"ABCDabcd123",1);
	LCD_ShowString(225,200,GREEN,RED,16,"ABCDabcd123",0);
	// 显示数字
	LCD_ShowNum(225,220,WHITE,BLACK,123456,7,16);
	// 显示图片
	LCD_Drawbmp16(270,120,gImage_qq);
	//  */
}
