...
uint8_t  LCD_Orientation = LCD_DISPLAY_ORIENTATION_LANDSCAPE;// 默认纵向
...
void Init_LCD(void)
{
    ...
    LCD_Set_Orientation(LCD_DISPLAY_ORIENTATION_LANDSCAPE);// 纵向
...
void LCD_Set_Orientation(uint8_t orientation)
{
	...
	uint8_t data[] = {(1<<3)|(0<<7)|(1<<6)|(1<<5), (1<<3)|(1<<7)|(1<<5), (1<<3)|(0<<6)|(0<<7), (1<<3)|(1<<6)|(1<<7)};
